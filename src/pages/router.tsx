    ...
    return (
        <Router history={history}>
            <Switch>
                ...
                <Route
                    path="/delegate"
                    component={withLockByAccount(withNavBar(PageDelegate))}
                />
                <Route
                    path="/delegations"
                    component={withLockByAccount(
                        withNavBar(PageDelegations, i18n.t("delegations.title"))
                    )}
                />
                <Route
                    path="/pendingundelegation"
                    component={withLockByAccount(
                        withNavBar(
                            PagePendingUndelegation,
                            i18n.t("undelegations.title")
                        )
                    )}
                />
                <Route
                    ...
                    component={withNavBar(
                        PagePoolList,
                        i18n.t("pool_lists.title")
                    )}
                />
                <Route
                    path="/undelegate"
                    component={withLockByAccount(
                        withNavBar(PageUndelegate, "")
                    )}
                />
                <Route
                    path="/withdraw"
                    component={withLockByAccount(withNavBar(PageWithdraw, ""))}
                />
                <Route
                    path="/history"
                    component={withLockByAccount(
                ...
                <Route
                    path="/operation"
                    component={withNavBar(PageOperation)}
                />
            </Switch>
        </Router>
    );
